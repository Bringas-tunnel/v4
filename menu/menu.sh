...
clear
echo -e "${Kcyan}_____________________________________________________${NC}"
echo -e "  ${red_background}           𝗕𝗿𝗶𝗻𝗴𝗮𝘀 𝗧𝘂𝗻𝗻𝗲𝗹𝗶𝗻𝗴              ${NC}"
echo -e "${Kcyan}_____________________________________________________${NC}"
echo -e "${white}_____________________________________________________${NC}" 
...
echo -e "|${pu} [•2]${NC}🟡 ${white} VMESS${NC}        ""${pu}[•7]${NC}🟡 ${white} RESTR SERVICE${NC}"  
echo -e "|${pu} [•3]${NC}🟡 ${white} VLESS${NC}        ""${pu}[•8]${NC}🟡 ${white} BACKUP MENU${NC}"
