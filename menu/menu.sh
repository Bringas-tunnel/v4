...
echo -e "\e[36m★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★\033[0m"
echo -e " [\e[36m•6\e[0m] 𝐜𝐥𝐞𝐚𝐫 𝐬𝐚𝐦𝐩𝐚𝐡"     "[\e[36m10\e[0m] set waktu reboot${NC}"
echo -e " [\e[36m•7\e[0m] 𝐑𝐞𝐬𝐭𝐚𝐫𝐭 𝐬𝐞𝐫𝐯𝐜$NC"  "[\e[36m11\e[0m] cek Running${NC}"
echo -e " [\e[36m•8\e[0m] 𝐬𝐬𝐡 𝐚𝐜𝐭𝐢𝐯𝐞$NC"     "[\e[36m12\e[0m] reboot X-Ray${NC}"
echo -e " [\e[36m•9\e[0m] 𝐠𝐚𝐧𝐭𝐢 𝐩𝐰 𝐯𝐩𝐬$NC"  "[\e[36m13\e[0m] settings menu${NC}"
echo -e "\e[36m▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓\033[0m"
