...
echo -e "${Kcyan}┌───────────────────────────────────────────┐${NC}"
echo -e "${MK}SSH : $ssh1 │ VMES : $vma │ VLES : $vla │ TROJAN : $tra "
echo -e "${Kcyan}└───────────────────────────────────────────┘${NC}"
echo -e "${Kcyan}┌───────────────────────────────────────────┐${NC}"
...
echo -e "${Kcyan}│${NC}${Kbiru} [•2]${NC}📨 ${white} VMESS${NC}        ""${Kbiru}[•7]${NC}📨 ${white} RESTR SERVICE${NC}"  
echo -e "${Kcyan}│${NC}${Kbiru} [•3]${NC}📨 ${white} VLESS${NC}        ""${Kbiru}[•8]${NC}📨 ${white} BACKUP MENU${NC}"
echo -e "${Kcyan}│${NC}${Kbiru} [•4]${NC}📨 ${white} TROJAN-GO${NC}    ""${Kbiru}[•9]${NC}📨 ${white} SET PASW VPS${NC}"
echo -e "${Kcyan}│${NC}${Kbiru} [•5]${NC}📨 ${white} TROJAN-WS${NC}    ""${Kbiru}[10]${NC}📨 ${white} REBOOT SETTINGS${NC}"
echo -e "${Kcyan}└───────────────────────────────────────────┘"    
echo -e "                    ${green}   11 ${NC}          "
