...
echo -e "║${white} CPU           ${NC}★ ${cyan} $cpu_usage"
echo -e "║${white} CPU CORES     ${NC}★ ${cyan} $cores"
echo -e "║${cyan} WHATSAPP      ${NC}★ ${cyan} 085955333616"
echo -e "║${white}╘━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╛${NC}" 
...
echo -e "║${cyan}          └────────────────────────┘${NC}"
echo -e "${white}╠════════════════════════════════════════════╣${NC}"
echo -e "║${white}[•1]${NC}║ ${kuning}ꜱꜱʜ${NC}        ""║${white}[•6]${NC}║ ${kuning}Check Running${NC}"
echo -e "║${white}[•2]${NC}║ ${kuning}ᴠᴍᴇꜱꜱ${NC}      ""║${white}[•7]${NC}║ ${kuning}Restart Service${NC}"  
echo -e "║${white}[•3]${NC}║ ${kuning}ᴠʟᴇꜱꜱ${NC}      ""║${white}[•8]${NC}║ ${kuning}Menu Backup${NC}"
echo -e "║${white}[•4]${NC}║ ${kuning}ᴛʀᴏᴊᴀɴ-ɢᴏ${NC}  ""║${white}[•9]${NC}║ ${kuning}Set Pw Vps${NC}"
echo -e "║${white}[•5]${NC}║ ${kuning}ᴛʀᴏᴊᴀɴ-ᴡꜱ${NC}  ""║${white}[10]${NC}║ ${kuning}Set Reboot${NC}"
echo -e "${white}╠════════════════════════════════════════════╣${NC}"    
echo -e "║                 ${green}   0 ${NC}          "
