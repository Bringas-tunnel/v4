...
echo -e "${GREEN}└───────────────────────────────────────────────┘${NC}"
echo -e "\e[36m┌─────────────────────────────────────────────────┐\033[0m"
echo -e " [\e[33m•1\e[0m] 𝗦𝗦𝗛"          "[\e[36m•6\e[0m] 𝐜𝐥𝐞𝐚𝐫 𝐬𝐚𝐦𝐩𝐚𝐡"
echo -e " [\e[33m•2\e[0m] 𝗩𝗠𝗘𝗦𝗦"        "[\e[36m•7\e[0m] 𝐑𝐞𝐬𝐭𝐚𝐫𝐭 𝐬𝐞𝐫𝐯𝐜$NC"     
echo -e " [\e[33m•3\e[0m] 𝗩𝗟𝗘𝗦𝗦"         "[\e[36m•8\e[0m] 𝐬𝐬𝐡 𝐚𝐜𝐭𝐢𝐯𝐞$NC"
echo -e " [\e[33m•4\e[0m] 𝗧𝗥𝗢𝗝𝗔𝗡-go"    "[\e[36m•9\e[0m] 𝐠𝐚𝐧𝐭𝐢 𝐩𝐰 𝐯𝐩𝐬$NC"
echo -e " [\e[33m•5\e[0m] 𝗧𝗥𝗢𝗝𝗔𝗡-ws"    "[\e[33m10\e[0m] 𝐬𝐞𝐭 𝐫𝐞𝐛𝐨𝐨𝐭${NC}"
echo -e "\e[36m└─────────────────────────────────────────────────┘\033[0m"      
echo -e                    "[\e[33m11\e[0m] 𝐜𝐞𝐤 𝐫𝐮𝐧𝐧𝐢𝐧𝐠${NC}"
echo -e                    "[\e[33m12\e[0m] 𝐫𝐞𝐛𝐨𝐨𝐭 𝐱-𝐫𝐚𝐲${NC}"
echo -e                    "[\e[33m13\e[0m] 𝐬𝐞𝐭𝐭𝐢𝐧𝐠𝐬 𝐦𝐞𝐧𝐮${NC}"
echo -e "\e[36m▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓\033[0m"
