...
echo -e "${white}╘━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╛${NC}"
echo -e "${white} IP VPS ${NC}: $IPVPS"        "SSH    : $ssh1"
echo -e "${white} ISP    ${NC}: $ISP"          "VMESS  : $vma"
echo -e "${white} CPU    ${NC}: $cpu_usage"    "VLESS  : $vla"
echo -e "${white} RAM    ${NC}: $tram Mb"      "TROJAN : $tra"
echo -e "${white}╘━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╛${NC}" 
echo -e "${white}╒━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╕${NC}" 
...
echo -e "${white}╠═══════════════════════════════════════════╣${NC}"
echo -e "${pu}[•1]${NC}🟡 ${white}SSH${NC}         ""║${pu}[•6]${NC}🟡 ${kuning}CHECK RUNNING${NC}"
echo -e "${pu}[•2]${NC}🟡 ${white}VMESS${NC}       ""║${pu}[•7]${NC}🟡 ${kuning}RESTR SERVICE${NC}"  
echo -e "${pu}[•3]${NC}🟡 ${white}VLESS${NC}       ""║${pu}[•8]${NC}🟡 ${kuning}BACKUP MENU${NC}"
echo -e "${pu}[•4]${NC}🟡 ${white}TROJAN-GO${NC}   ""║${pu}[•9]${NC}🟡 ${kuning}SET PASW VPS${NC}"
echo -e "${pu}[•5]${NC}🟡 ${white}TROJAN-WS${NC}   ""║${pu}[10]${NC}🟡 ${kuning}REBOOT SETTINGS${NC}"
echo -e "${white}╠═══════════════════════════════════════════╣${NC}"    
echo -e "                 ${green}   11 ${NC}          "
