...
clear                
		    ...
		    echo -e "                                ${ug}${g}LIST${NC}"
                    echo -e "                          └───────────────┘"
                    echo -e "                 ${u}SSH          [ ACCOUNT ]${NC} = ${w}  $ssh1 ${NC}"
		    echo -e "                 ${u}VMESS        [ ACCOUNT ]${NC} = ${w}  $vma  ${NC}"
	            echo -e "                 ${u}VLESS        [ ACCOUNT ]${NC} = ${w}  $vla  ${NC}"
		    echo -e "                 ${u}TROJAN       [ ACCOUNT ]${NC} = ${w}  $tra  ${NC}"
		    echo -e "                          ┌───────────────┐"
		    echo -e "                                ${ug}${g}MENU${NC}"
                    echo -e "                          └───────────────┘"
